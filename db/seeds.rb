...
", location: "Dayton, Ohio", category: 'Performing & Visual Arts' , start_date: "20/08/2022" , end_date: "21/08/2022", start_time: "09:00:00", end_time: "23:00:00" , host_id: kanye.id )
file11 = URI.open('https://active-storage-ensombryte-dev.s3.us-west-1.amazonaws.com/wgi.jpeg')
wgi.photo.attach(io: file11, filename:'wgi.jpeg')

Registration.create!(user_id: demo.id, event_id: coachella.id)
Registration.create!(user_id: cow.id, event_id: coachella.id)
