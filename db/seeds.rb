...
User.create!( email: 'Kanye West', fname: 'Kanye', lname: 'West', password: 'Kanye West')
User.create!( email: 'cowcowsssw', fname: 'Insomniac', lname: 'Inc', password: 'Insomniac')
User.create!( email: 'cowcosss', fname: 'Quest', lname: 'Crew', password: 'cowcoww')
User.create!( email: 'cowcowwssaa', fname: 'Vitalik', lname: 'Buterin', password: 'cowcoww')
User.create!( email: 'cowcodafkw', fname: 'The', lname: 'Fung Bros', password: 'cowcoww')
User.create!( email: 'cowcoqwww', fname: 'Naruto', lname: 'Uzumaki', password: 'cowcoww')
User.create!( email: 'cowcoqweqweww', fname: 'Bryan', lname: 'Eats', password: 'cowcoww')
User.create!( email: 'cowcsasoww', fname: 'Rich', lname: 'Brian', password: 'cowcoww')
User.create!( email: 'cowcovvvvvww', fname: '21', lname: 'Savage', password: 'cowcoww')
...
Curfew 11pm Saturday / 10pm Sunday.", location: "ROSE BOWL STADIUM,Pasadena, CA", category: 'Music Festival' , start_date: "20/08/2022" , end_date: "21/08/2022", start_time: "09:00:00", end_time: "23:00:00" , host_id: 10 )
...
Like.create!(user_id: 1, event_id: 8)
Like.create!(user_id: 2, event_id: 7)
Like.create!(user_id: 2, event_id: 6)
Like.create!(user_id: 1, event_id: 5)
Like.create!(user_id: 1, event_id: 4)
Like.create!(user_id: 1, event_id: 3)
Like.create!(user_id: 1, event_id: 2)
Like.create!(user_id: 2, event_id: 1)
Like.create!(user_id: 2, event_id: 4)
